	...
	<div class="card-body">
		<div class="d-flex justify-content-between">
			...
			<div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
				<a class="btn btn-primary btn-sm" href="{{ route('company.index') }}" title="Back"><span class="fa fa-caret-left"></span> Back</a>
			</div>
		  </div>
		...
		<div class="flex-grow-1">
            <br>
			<form method="POST" action="{{ route('company.store', ['id' => $id]) }}" enctype="multipart/form-data">
				@csrf
				<div class="row">
					<div class="col-md-6">
						<div class="mb-2">
							<label class="form-label fw-bold" for="name">Name<span class="text-danger">*</span></label>
							<input placeholder="Name" class="form-control form-control-sm @error('name') is-invalid @enderror" type="text" maxlength="255" name="name" id="name" value="{{ old('name', $company->name) }}" style="">
					...
					<div class="col-md-6">
						<div class="mb-2">
							...
							<input placeholder="Alias" class="form-control form-control-sm @error('alias') is-invalid @enderror" type="text" maxlength="255" name="alias" id="alias" value="{{ old('alias', $company->alias) }}" style="">
