            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                    <a href="{{ route('role.add') }}" class="btn btn-sm btn-success text-light">
                ...
                @foreach ($rows as $row)
                    <tr>
                        ...
                        <td  class="project-actions text-right">
                            <a class="btn btn-success btn-sm text-light" href="{{ route('role.edit', ['id' => $row->id]) }}">
                                <i class="fa fa-pencil"></i>
                                </i>
                                Edit
                            </a>
                            <a class="btn btn-danger btn-sm row-delete-btn text-light" href="{{ route('role.delete', ['id' => $row->id]) }}" data-msg="Delete this item?" data-text="#{{ $row->id }}" title="Delete">
